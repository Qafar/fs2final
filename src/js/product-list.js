...
fromSlider.oninput = () =>{ controlFromSlider(fromSlider, toSlider, fromInput);console.log("input1")}
toSlider.oninput = () => {controlToSlider(fromSlider, toSlider, toInput);console.log("input2")}
